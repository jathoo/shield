<div id="entry-<?php echo $post->id; ?>" class="multi post entry-multi-list <?php echo $post->statusname; ?> <?php echo Post::type_name( $post->content_type ); ?>">
	<div class="head">
		...
		<h3 class="title"><a href="<?php echo $post->link; ?>" title="Visit link"><?php echo $post->title_out; ?></a></h3>
		<a class="link" href="<?php echo $post->permalink; ?>" title="Get the post permalink">permalink</a>
	</div>
	<div class="meta">
